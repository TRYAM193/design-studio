  ...
  "privacy": {
    ...
    content: (
      <>
        ...
        <p>We share shipping data with our print partners solely for the purpose of delivering your order.</p>
      </>
    )
  },
  "terms": {
  ...
  "refunds": {
    ...
    content: (
      <>
        ...
        <p>Please contact us at <a href="mailto:support@tryam.com" className="text-orange-500">support@tryam.com</a> within a week of delivery with a photo of the issue.</p>
        <h3>Cancellations</h3>
        <p>Orders are sent to production automatically. You may cancel within 1 hour of placing the order by contacting our suport.</p>
      </>
    )
  },
  "shipping": {
    ...
    content: (
      <>
        ...
        <ul>
            <li><strong>India:</strong> 5-10 Business Days after production.</li>
        </ul>
        <p><em>Note: Shipping times are estimates and not guarantees. Delays may occur during holidays(+/- 2 Days).</em></p>
      </>
    )
  }
};
