...
import { FiTrash2, FiRotateCcw, FiRotateCw, FiSettings, FiX, FiCheckCircle, FiChevronDown, FiDroplet } from 'react-icons/fi';
                ...
                <main className="preview-area relative bg-slate-100 flex items-center justify-center overflow-hidden" ref={containerRef}>
                    ...
                    <div className="top-bar consolidated-bar">
                        ...
                        {!selectedId && !showColorPanel && (
                            <button className="top-bar-button accent phone-only" onClick={() => setShowColorPanel(true)}><Fi size={18} /> Colors</button>
                        )}
                        <div className="control-group">
                            {fabricCanvas && (
                                <SaveDesignButton
